...
const fs = require('fs'); // package with node.js
const path = require('path'); // package with node.js
...
/// /api/product/article?id=HSHSHSKSK,JSJSJSJS,SDSDHHSHDS,JSJJSDJ&type=single (single or array here) // 4 ids
...
// default - if route doesn't match any above
if (process.env.NODE_ENV === 'production') { // if true - we are on heroku
